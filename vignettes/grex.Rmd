...
As an example, we use the Ensembl IDs from GTEx V6p gene count data
and select 100 IDs:
...
```{r}
filtered_genes = df[!is.na(df$"entrez_id"),
...
We thank the members of the [Stephens lab](http://stephenslab.uchicago.edu)
